...
:SINCE: Thu Jan 14 18:11:04 2016
:VERSION: 0.1
...
__copyright__ = ''
__license__ = ''
__date__ = 'Thu Jan 14 18:11:04 2016'
__version__ = '0.1'
...
71636269561882670428252483600823257530420752963450"
    ...
    for i in xrange(len(theNumber) - 13):

        currentDigits = theNumber[i:i+13]
        product = 1

        for j in xrange(13):
            product *= int(currentDigits[j])
